      ...
      <MaxWidthContainer>
        <section className="pt-8 pb-16 -mb-8 -mt-4">
          <Breadcrumbs
            ...
            capitalizeLinks
          />
          <div className="bg-white/90 backdrop-blur-sm shadow-xl rounded-md">
            <div className="p-10 rounded-md flex flex-col gap-8">
              ...
              <p className="text-muted-foreground">
                ...
                death, marriage, and residential certificates. Our mission is to
                provide a convenient and efficient solution for individuals to
                obtain these essential documents without hassle.
              </p>
              <p className="text-muted-foreground">
            ...
            <div className="p-10 rounded-md flex flex-col gap-8">
              ...
              <div className="bg-background/50 shadow-sm rounded-md border border-border p-6">
                ...
                <p className="text-muted-foreground">
                  At Gov-Certify, we strive to simplify the process of obtaining
                  vital records by providing an accessible and user-friendly
                  platform.
                </p>
              </div>
              <div className="bg-background/50 shadow-sm rounded-md border border-border p-6">
                ...
                <p className="text-muted-foreground">
                  Our aim is to streamline bureaucratic procedures, saving time
                  and effort for individuals seeking essential certificates.
                </p>
              </div>
            </div>
            ...
            <div className="p-10 rounded-md flex flex-col gap-8">
              ...
              <div className="bg-background/50 shadow-sm rounded-md border border-border p-6">
                <p className="text-lg font-semibold mb-2">Reached Milestone</p>
                <p className="text-muted-foreground">
